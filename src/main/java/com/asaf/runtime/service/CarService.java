...
public class CarService {
  ...
  public boolean updateCarNoMerge(Car car, CarCreate carCreate) {
    ...
    if (carCreate.getName() != null && (!carCreate.getName().equals(car.getName()))) {
      car.setName(carCreate.getName());
      update = true;
    }

    if (carCreate.getDescription() != null
        && (!carCreate.getDescription().equals(car.getDescription()))) {
      car.setDescription(carCreate.getDescription());
      update = true;
    }
